...
namespace RealTimeThemingEngine.ThemeManagement.Core.Interfaces
{
    public interface IThemeRepository
    {
        ...
        /// <returns></returns>
        ThemeModel GetThemeWithVariablesById(int id);
        ...
        List<ThemeVariableValueModel> GetThemeVariableValues(int id);
        ...
        ThemeVariableValueModel GetThemeVariableValueById(int id);

        /// <summary>
        /// Get theme variable categories.
        /// </summary>
        /// <returns>A collection of theme variable categories</returns>
        List<ThemeVariableCategoryModel> GetThemeVariableCategories();

        /// <summary>
        /// Get theme variable types.
        /// </summary>
        /// <returns>A collection of theme variable types</returns>
        List<ThemeVariableTypeModel> GetThemeVariableTypes();
        ...
        /// <returns></returns>
        List<ThemeVariableValueModel> GetThemeVariableValuesByVariableId(int id);
        ...
        int CreateTheme(ThemeModel theme, int themeToCloneId);

        /// <summary>
        /// Save any changes to a theme (not including theme variables).
        /// </summary>
        /// <param name="theme"></param>
        void SaveThemeChanges(ThemeModel theme);
        ...
        int ImportTheme(string name, List<ThemeVariableValueModel> values);

        /// <summary>
        /// Update the theme variable values.
        /// </summary>
        /// <param name="themeVariables">Collection of theme variables</param>
        void UpdateThemeVariableValues(IEnumerable<ThemeVariableValueModel> themeVariables);
